...
use lilconfig::{default_loaders, default_loaders_sync, Lilconfig};
...
#[test]
fn default_loader_tables_expose_json_and_no_ext() {
    for table in [default_loaders(), default_loaders_sync()] {
